...
def test_create_object(get_start_and_stop_testing, print_before_after, obj):
...
def test_update_object(create_and_delete_object, print_before_after):
...
@pytest.mark.medium
def test_update_part_of_object(create_and_delete_object, print_before_after):
...
def test_remove_object(create_object, print_before_after):
