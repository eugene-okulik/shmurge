...
s_king_shine = Book(title="Сияние",
                    author="Стивен Кинг",
                    num_of_pages="600",
                    isbn="521-7-12345-333-1",
                    is_reserved=False)

j_abercrombie_blood_and_iron = Book(title="Кровь и железо",
                                    author="Джо Аберкромби",
                                    num_of_pages="780",
                                    isbn="521-7-461776-333-1",
                                    is_reserved=False)

a_neville_ritual = Book(title="Ритуал",
                        author="Адам Нэвилл",
                        num_of_pages="460",
                        isbn="521-7-324895-441-1",
                        is_reserved=False)

n_nosov_dunno_on_the_moon = Book(title="Незнайка на луне",
                                 author="Николай Носов",
                                 num_of_pages="380",
                                 isbn="521-7-567934-442-1",
                                 is_reserved=False)

d_gluhovsky_metro2033 = Book(title="Метро 2033",
