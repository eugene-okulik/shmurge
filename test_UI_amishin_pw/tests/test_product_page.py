...
from test_UI_amishin_pw.data_for_tests.data_for_tests import ProductInfo
...
class TestProductPage(BaseTest):
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    @pytest.mark.parametrize('add_quantity', [1, 2, 3, 4, 5, 6, 7, 10, 25])
    def test_add_multiple_units_of_the_same_product(self, add_quantity, pre_goto_prod_page):
