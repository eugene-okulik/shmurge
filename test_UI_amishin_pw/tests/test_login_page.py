...
from test_UI_amishin_pw.data_for_tests.data_for_tests import PlaceHolder, UserData, ErrorMessage
...
class TestLoginPage(BaseTest):
    ...
    def test_unregistered_user_can_not_login(self):
        self.login_page.open()
        self.login_page.is_opened()
        self.login_page.fill_email_input(UserData.RANDOM_EMAIL)
        self.login_page.fill_password_input(UserData.RANDOM_PASSWORD)
